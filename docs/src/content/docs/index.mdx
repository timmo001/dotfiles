...
export const getStartedCards = [
  { title: 'Getting Started', href: '/getting-started/', description: 'Bootstrap a fresh machine and run the ongoing workflow.' },
...
export const exploreCards = [
  ...
  { title: 'Configuration & Reference', href: '/configuration/', description: 'Environment options, private git config, and private packages.' },
