...
| Page | Why |
| --- | --- |
| [Overview](/agents/opencode/overview/) | Primary coding-agent harness |
| [Agents](/agents/opencode/agents/) | Generated catalogue of OpenCode agents |
| [Commands](/agents/opencode/commands/) | Generated catalogue of slash commands |
| [Plugins](/agents/opencode/plugins/) | Generated catalogue of lifecycle plugins |

Skills live in the <a href="https://github.com/timmo001/skills/blob/main/SKILLS.md#skills-catalogue" target="_blank" rel="noopener noreferrer">timmo001/skills</a> catalogue (not a local docs page).
