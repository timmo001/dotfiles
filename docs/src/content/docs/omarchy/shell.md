...
| `timmo.system-bridge` | service, bar-widget | Streams local CPU, memory, temperature, system, and optional battery health into a compact widget and read-only panel. |
