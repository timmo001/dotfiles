...
export const cards = [
  {
    ...
    href: "/dot/commands/",
    description:
      "Every command, alias, flag, and example, generated from the CLI registry.",
  },
  {
    title: "Stow Workflow",
    href: "/dot/stow/",
    description: "How packages are stowed into your home directory.",
  },
  {
    title: "Shell Setup",
    href: "/dot/shell/",
    description:
      "Zsh completions, editing keys, aliases, and small shell helpers.",
  },
  {
  ...
  },
  {
    ...
    href: "/dot/notes/",
    description: "The repository notes browser and handoff workflow.",
  },
  {
    title: "MCP Server",
    href: "/dot/mcp/",
  ...
  },
  {
    title: "Cleanup",
    href: "/cleanup/",
    description: "Remove stowed links and reverse setup side effects.",
  },
];
