...
| [`/commit-push-no-watch`](https://github.com/timmo001/dotfiles/blob/distro/arch-omarchy/agents/.config/opencode/commands/commit-push-no-watch.md) | Split current changes into coherent commits and push without workflow watchers | `default` |
