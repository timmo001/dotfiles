...
| [`notes-guard`](https://github.com/timmo001/dotfiles/blob/distro/arch-omarchy-quattro/agents/.config/opencode/plugins/notes-guard.ts) | Blocks direct file access to the repository notes vault |
