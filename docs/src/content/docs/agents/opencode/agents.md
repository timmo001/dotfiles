...
| [`researcher`](https://github.com/timmo001/dotfiles/blob/distro/arch-omarchy-quattro/agents/.config/opencode/agents/researcher.md) | Interactive primary-source research agent that compares claim-specific evidence |
