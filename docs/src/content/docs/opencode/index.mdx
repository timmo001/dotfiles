...
- **Generated artefact protection** - the `generated-artifact-guard` plugin keeps generated references, completions, the compiled `dot` binary, and the Open Graph image readable while blocking direct mutation and naming the canonical regeneration command.
