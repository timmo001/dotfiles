...
- **Contextual notifications** - top-level task completion and permission events emit an OSC 777 terminal notification, ring BEL, and play the freedesktop message sound when `paplay` is available. Background subagent completions stay silent.
