...
export const cards = [
  { title: 'FIDO2 Security Key Auth', href: '/knowledge-base/fido2-security-key-auth/', description: 'Set up Omarchy FIDO2 auth, then require a security-key PIN for sudo, polkit, and Hyprlock.' },
];
