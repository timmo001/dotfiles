...
There is no persistent Hyprland state to reset. To recover from a bad relayout, use Hyprland's normal move/split controls, apply another preset, or rerun [Workspace Setup](/knowledge-base/workspace-setup/).
