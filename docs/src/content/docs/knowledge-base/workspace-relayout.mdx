...
Preset names do not need to be unique. Walker appends a rounded ratio signature, such as `75% top [75/25, 16/16/16/52]`, to distinguish variants.
...
3. Press `SUPER+TAB`.
4. Choose a layout family from Walker, such as **Top / bottom** or **Left / right**.
