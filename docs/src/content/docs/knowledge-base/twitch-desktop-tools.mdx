...
| Binding | Action |
| --- | --- |
| `CTRL+ALT+T` | Open the Twitch panel. |
| `CTRL+ALT+SHIFT+T` | Open the Twitch panel. |
...
The panel shows live channels first, followed by configured offline channels. Select a live channel to open its stream or an offline channel to open its recent broadcasts.
