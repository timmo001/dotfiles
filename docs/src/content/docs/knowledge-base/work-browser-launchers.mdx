...
`workspace-setup` uses equivalent commands for the work slots. If a work app does not land on the expected workspace, test the launcher directly before debugging setup.
