  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description: "Omit the branch metadata block (affects --json)",
      },
      {
        name: "--no-status",
        description: "Omit the working-tree status block (affects --json)",
      },
      {
        name: "--no-work-scope",
        description: "Omit the branch work-scope block (affects --json)",
      },
      {
        name: "--diff",
