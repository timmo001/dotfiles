...
export const ENV = {
  ...
  DOT_MCP_CONFIG_FILE: "DOT_MCP_CONFIG_FILE",
  DOT_NOTES_DIR: "DOT_NOTES_DIR",
  DOT_SKILL_UPDATES_AGENT_LOCKED: "DOT_SKILL_UPDATES_AGENT_LOCKED",
  ...
  DOT_PUBLIC_PACMAN_MAIN_CONFIG: "DOT_PUBLIC_PACMAN_MAIN_CONFIG",
  DOT_PUBLIC_PACMAN_REPO_CONFIG: "DOT_PUBLIC_PACMAN_REPO_CONFIG",
  DOT_TEE_INHERIT_LOG: "DOT_TEE_INHERIT_LOG",
  DOT_UFW_RULES_FILE: "DOT_UFW_RULES_FILE",
  DOT_USAGE_DIR: "DOT_USAGE_DIR",
  DOT_USAGE_DISABLE: "DOT_USAGE_DISABLE",
