...
const RETIRED_PUBLIC_STOW_PATHS = [
  ...
  "systemd/.config/systemd/user/dot-doctor-startup.service",
  "systemd/.config/systemd/user/dot-doctor-startup.timer",
  "systemd/.config/dot/services.d/dot-doctor-startup.json",
