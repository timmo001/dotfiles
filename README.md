...
- `dot private-pkg-publish [--no-git] [--skip-build] <package>` - build and publish a mapped private package into the private pacman repo, sync the mirror, refresh pacman metadata, and commit/push by default
