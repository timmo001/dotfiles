...
- `.agents/skills/` contains repo-local skills for this repo only and is registered through `skills.paths` in `opencode.json`. Dotfiles-owned global skills live in the `dotfiles-skills/.agents/skills/` stow package.
