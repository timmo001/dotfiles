#!/bin/bash
# Direct HDR launcher script for launching game executables directly
# This bypasses Steam to avoid GPU detection issues
...
# Set all necessary environment variables for HDR
...
echo "Launching $GAME_PATH with HDR"
