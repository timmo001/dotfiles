...
Item {
  ...
  readonly property real contentScale: 0.55
  ...
  component ModuleSlot: Item {
    ...
    implicitWidth: activeItem && activeItem.visible
      ? (root.vertical ? root.barSize : Math.ceil(activeItem.implicitWidth * root.contentScale))
      : 0
    implicitHeight: activeItem && activeItem.visible
      ? Math.ceil(activeItem.implicitHeight * root.contentScale)
      : 0
    width: implicitWidth
