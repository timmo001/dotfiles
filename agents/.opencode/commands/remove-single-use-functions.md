...
Read and apply `agents/.opencode/rules/remove-single-use-functions.md` before editing.
...
4. Apply the smallest safe cleanup that satisfies `agents/.opencode/rules/remove-single-use-functions.md`.
